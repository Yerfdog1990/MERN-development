...
# Installing Tailwind CSS in a React Router Project

This section demonstrates how to install and configure **Tailwind CSS** in a **React Router** project created with **Create React Router**.

## Step 1: Create a React Router Project

If you don't already have a React Router project, create one using **Create React Router**.
...
This command creates a new React Router application named **my-project** and changes into the project directory.

---

## Step 2: Install Tailwind CSS

Install Tailwind CSS together with the Vite plugin.
...
* **@tailwindcss/vite** – the official Vite plugin that integrates Tailwind with Vite.

---

## Step 3: Configure the Vite Plugin

Open **`vite.config.ts`** and import the Tailwind plugin.
...
Adding `tailwindcss()` to the `plugins` array enables Tailwind CSS during the build process.

---

## Step 4: Import Tailwind CSS

Open **`app/app.css`** and import Tailwind CSS.

```css
@import "tailwindcss";
```

This single import loads Tailwind's utility classes into your application.
...
The development server compiles your application and watches for file changes, automatically refreshing the browser whenever you save your work.

---

## Step 6: Use Tailwind CSS Classes

You can now style your React components using Tailwind's utility classes.
...
When you open the application in your browser, the **Hello world!** heading should appear in a large, bold, underlined font, confirming that Tailwind CSS has been successfully installed and configured.
...
| Tailwind Value |        rem | Pixels (1rem = 16px) | Example Class |
| -------------: | ---------: | -------------------: | ------------- |
|            `0` |     `0rem` |                `0px` | `p-0`         |
|           `px` |          — |                `1px` | `p-px`        |
...
### 7.3. Colors (examples from default palette):
```css
